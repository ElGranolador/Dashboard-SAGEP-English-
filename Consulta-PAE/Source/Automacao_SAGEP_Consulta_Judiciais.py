...
def run_automation():
    ...
    with sync_playwright() as p:
        ...
        df = pd.read_excel('C:\\Users\\SEDUC\\Desktop\\Automacao-Sagep-Seduc\\Armazenamento-Protocolo-Seduc-SAGEP\\Planilha_Tratada\\Planilha_Processos_Judicial.xlsx')
        ...
        df_global = df_global.drop_duplicates(keep='first')
        df_global.to_excel('Planilha_Bruta\\Planilha_Judiciais_bruta_consulta.xlsx', index=False)

        subprocess.run(["pyhton","Source\\Tratamento_Planilha_Consulta.py"])
        subprocess.run(["pyhton","Source\\Tratamento_Planilha_Dash.py"])
